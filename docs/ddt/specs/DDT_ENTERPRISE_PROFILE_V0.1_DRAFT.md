# DDT Enterprise Profile v0.1 — Draft

**Project:** Diamond Data Chain (DDC)  
**Specification ID:** `DDT-ENTERPRISE-PROFILE-0.1-DRAFT.1`  
...
- `subjectNamespaces` — non-empty set of permitted subject-reference namespaces; and
...
A validator MUST reject a record whose `recordType` or subject namespace is outside the bound profile scope.
...
- a changed domain scope or record type;
...
**End of DDT Enterprise Profile v0.1 Draft (`0.1.0-draft.1`)**
